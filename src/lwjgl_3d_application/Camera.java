...
public class Camera {
    ...
    */
    ...
    public Camera(float field_of_view, float aspect_ratio, float near_clipping_plane, float far_clipping_plane) {
    ...
    */
	...
	// Unless we enable textures, we will not see them mapped on surfaces!!
